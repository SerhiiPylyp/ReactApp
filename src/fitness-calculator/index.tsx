...
import {Result, Container, Fields, InputBlock, Input, Bmi, Health, Back} from "./styled";
        ...
        <Container onSubmit={calculate}>
            ...
            <Fields>
                <InputBlock>
                    ...
                    <Input min={130} max={230} value={height} onChange={(value) => onChange(setHeight, value)}/>
                </InputBlock>
                <InputBlock>
                    <label>Enter weight (kg)</label>
                    <Input min={40} max={160} value={weight} onChange={(value) => onChange(setWeight, value)}/>
                </InputBlock>
                <InputBlock>
